...
def get_dnn_model(model_name, num_classes, pretrained=False):
    if model_name == 'alexnet':
        return alexnet(num_classes=num_classes)
    elif model_name == 'densenet':
        return densenet(num_classes=num_classes)
    elif model_name == 'densenet121':
        return torchvision.models.densenet121(num_classes=num_classes, pretrained=pretrained)
    elif model_name == 'preresnet':
        return preresnet(num_classes=num_classes)
        ...
        return wrn(num_classes=num_classes)
    elif model_name == 'lenet5':
        return lenet5(num_classes=num_classes)
    else:
        raise ValueError('Model name is not found.')
